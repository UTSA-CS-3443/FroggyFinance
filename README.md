...
## **Video Demonstration**
Link: https://drive.google.com/file/d/1SBjNvkt3oflks2rJ_CCvgVACuz6zp9tV/view?usp=sharing

## **UML Diagram**
Image: https://github.com/user-attachments/assets/57c3a5bd-928c-4478-8be2-4c6e2a09a7ab
...
3. Build and run the project from GameLauncher.java.

## **How to use**
This app is easy to use and user friendly.
1. The app uses two menus to keep everything organized and easy to navigate. The Utility Menu gives users quick access to helpful tools like the Notepad, Calculator, Tutorial, and the option to start the game. Once users enter the actual game experience, they are taken to the Game Menu, which focuses on gameplay-related options such as continuing or starting the game, adjusting settings, and viewing the credits. Separating these menus keeps everyday tools and game features clear, simple, and user-friendly.
2. **Calculator** The calculator gives the player the ability to quickly calculate the square and square root of numbers. Also helps with adding, subtracting, multiplying, and dividing different numbers. It works primarily with doubles but doesn't force the user to use the decimal button if they're working with ints, it'll automatically convert into an int. The calculator also has the ability of changing negative numbers to positive numbers or vice versa. It's easy to get rid of information via the clear button and calculations are made using the equals button.
...
Lauren Hinnen - Project Froggy Finance Calculator.
